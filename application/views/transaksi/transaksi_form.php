...
<html>
  ...
  <div class="card">
	   ...
	   <!--  <div class="form-group">
            <label for="timestamp">Tgl Transaksi <?php echo form_error('tgl_transaksi') ?></label>
	    ...
	    <div class="form-group">
            <label for="int">Id Pengirim <?php echo form_error('id_pengirim') ?></label>
	    ...
	    <div class="form-group">
            <label for="varchar">No Tlp Pengirim <?php echo form_error('no_tlp_pengirim') ?></label>
            <input type="text" class="form-control" name="no_tlp_pengirim" id="no_tlp_pengirim" placeholder="No Tlp Pengirim" value="<?php echo $no_tlp_pengirim; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label for="int">Id Penerima <?php echo form_error('id_penerima') ?></label>
            <input type="text" class="form-control" name="id_penerima" id="id_penerima" placeholder="Id Penerima" value="<?php echo $id_penerima; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label for="varchar">No Tlp Penerima <?php echo form_error('no_tlp_penerima') ?></label>
            <input type="text" class="form-control" name="no_tlp_penerima" id="no_tlp_penerima" placeholder="No Tlp Penerima" value="<?php echo $no_tlp_penerima; ?>" />
        </div>
	    <div class="form-group">
